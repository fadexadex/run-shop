        ...
        <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-blue-600 to-indigo-700">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="max-w-2xl text-white">
              ...
              <p className="text-xl mb-8">Join thousands of teams who use TaskFlow to accomplish more every day.</p>
              <div className="grid grid-cols-2 gap-6">
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 mr-2 text-blue-300" />
                  <div>
                    <h3 className="font-semibold">Task Management</h3>
                    <p className="text-blue-100">Create, organize, and prioritize tasks with ease</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 mr-2 text-blue-300" />
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Monitor project progress in real-time</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 mr-2 text-blue-300" />
                  <div>
                    ...
                    <p className="text-blue-100">Never miss important deadlines again</p>
                  </div>
                </div>
              </div>
            </div>
